/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv` (hash: 8ecaab63e42a28c9b9d682a79b5b646e)
// Runtime types generated with workerd@1.20260424.1 2026-03-29 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		DB: D1Database;
		ASSETS: Fetcher;
		ALCHEMY_STATE_TOKEN: string;
		OPENCODE_EXPERIMENTAL_LSP_TOOL: string;
		OPENCODE_EXPERIMENTAL_OXFMT: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALCHEMY_STATE_TOKEN" | "OPENCODE_EXPERIMENTAL_LSP_TOOL" | "OPENCODE_EXPERIMENTAL_OXFMT">> {}
}
